          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  <h2 className="font-['Impact:Regular',_sans-serif] text-[32px] text-[#00306e] mb-2">My Profile</h2>
                  <p className="font-['Alumni_Sans:Regular',_sans-serif] text-[20px] text-gray-600">{userEmail}</p>
                </div>
              </div>

              <div className="space-y-6">
                <div>
                  <h3 className="font-['Alumni_Sans:Regular',_sans-serif] text-[24px] text-[#00306e] mb-4">Account Statistics</h3>
                ...
                <div>
                  <h3 className="font-['Alumni_Sans:Regular',_sans-serif] text-[24px] text-[#00306e] mb-4">Account Actions</h3>
